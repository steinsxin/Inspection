...
class ServerSubscriber(Node):
    def __init__(self):
        ...
        self.get_logger().info("IMU subscriber started, waiting for /gv_imu topic data...")
        ...
        self.get_logger().info("Battery subscriber started, waiting for /gv_battery topic data...")
        ...
        self.get_logger().info("Rear lidar subscriber started, waiting for /gv_rear_lidar topic data...")
        ...
        self.get_logger().info("Front lidar subscriber started, waiting for /gv_front_lidar topic data...")
